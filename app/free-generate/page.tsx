...
useEffect(() => {
  ...
  const generatePrompt = () => {
    ...
    prompt +=
      "IMPORTANT: Use a bright, vibrant, and colorful palette throughout the image with sharp, crisp details and clear edge definition. Avoid dark or muted colors - make the artwork pop with vivid, saturated colors, bright lighting, and eye-catching effects. The overall mood should be energetic and visually striking with high contrast and luminous colors.\n";
    prompt +=
