  ...
  if (compact) {
    return (
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent
          className="w-[280px] p-0 bg-cyber-dark border-cyber-cyan/30"
          align="start"
        >
            ...
            <CommandGroup className="max-h-64 overflow-auto">
              {CARD_CATEGORIES.map(category => (
                <CommandItem
                  ...
                  className="cursor-pointer text-white hover:bg-cyber-cyan/20 aria-selected:bg-cyber-cyan/10"
                >
                  <Check
                    className={cn(
                      "mr-2 h-4 w-4",
  ...
  return (
    <div className={className}>
      ...
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent
          className="w-full p-0 bg-cyber-dark border-cyber-cyan/30"
          align="start"
          sideOffset={5}
        >
          <Command className="bg-transparent">
            ...
            <CommandGroup className="max-h-64 overflow-auto">
              {CARD_CATEGORIES.map(category => (
                <CommandItem
                  ...
                  value={category.value}
                  onSelect={() => toggleCategory(category.value)}
                  className="cursor-pointer text-white hover:bg-cyber-cyan/20"
                >
                  <Check
                    className={cn(
                      "mr-2 h-4 w-4",
